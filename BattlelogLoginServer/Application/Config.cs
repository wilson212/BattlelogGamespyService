...
namespace Server
{
    ...
    public static class Config
    {
        ...
        static Config()
        {
            ...
            source = new IniConfigSource(IniLocation);
        }
        ...
        public static string GetValue(string Section, string Key)
        {
            ...
            return source.Configs[Section].GetString(Key);
        }
        ...
        public static T GetType<T>(string Section, string Key) where T : IConvertible
        {
            ...
            return (T)Convert.ChangeType(source.Configs[Section].Get(Key), typeof(T), CultureInfo.InvariantCulture);
        }
